...
<section class="home_banner_area">
    ...
    <div class="container">
        <div class="banner_content">
            <main class="py-5">
                <section id="Agregado" class="mb-5">
                    <div class="container">
                        <h2 class="mb-4">Agregar Tipos de Plaza</h2>
                        <form method="post" action="<?php echo FRONT_ROOT ?>Eventype/AddEventype" class="bg-light-alpha p-5">
...
<section id="listado" class="mb-4 mt-4">
    <div class="container">
        <h2 class="mb-30 title_color progress-table-wrap" align="center">Listado de Tipos de Plaza</h2>
            ...
            <tbody>
                ...
                if(isset($eventTypeList)) {
                    foreach($eventTypeList as $eventType) {?>
                        <tr>
                            <td><?php echo $eventType->getId(); ?></td>
                            <td><?php echo $eventType->getDesc(); ?></td>
                            <td><?php 
                                if($eventType->getActive() == 1) {
                                    echo "Activo";
                                }
                                else {
                                    echo "Inactivo";
        ...
        <div class="card-deck mb-3 text-center">  
            <div class="card mb-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo FRONT_ROOT ?>Eventype/UpdateEventype" class="">
            ...
            <div class="card mb-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo FRONT_ROOT ?>Eventype/ChangeStateEventype" class="">
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" name="id" id="basic-url" aria-describedby="basic-addon3" required>
                        </div>
